...
def generate_key_link(key_free):
    url = f"https://lkztool.work.gd/index.html?key={key_free}"
...
def main():
    ...
    # Key VIP
        ...
        saved_key = read_saved_key()
        if saved_key and check_vip_key(saved_key):
            print("\033[1;32mBẢN QUYỀN THUỘC: \033[1;31mLKZ TOOL")
        else:
            while True:
